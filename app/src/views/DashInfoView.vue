...
async function loadSiteInfo() {
  try {
    const response = await axios.get('https://backend-ccg-production.up.railway.app/api/site-info');
...
async function updateSiteInfo() {
  try {
    await axios.post('https://backend-ccg-production.up.railway.app/api/site-info', siteInfo.value);
